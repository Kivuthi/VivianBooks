                        ...
                        <tr class="border-b">
                            <td class="py-4 px-6 whitespace-nowrap">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">{{ $featuredBook->title }}</p>
                                        <p class="text-xs text-gray-500">{{ $featuredBook->author }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-4 whitespace-nowrap">{{ $featuredBook->category }}</td>
                            <td class="py-4 px-6 whitespace-nowrap">
                                <div>
                                    <p>S.Copy <span>{{ $featuredBook->softCopyPrice }}</span></p>
                                    <p>H.Copy <span>{{ $featuredBook->hardCopyPrice }}</span> </p>
                                </div>
                            </td>
                            <td class="py-4 px-6 whitespace-nowrap">{{ $featuredBook->status }}</td>
                            ...
                            <td class="relative inline-block py-4 px-6 whitespace-nowrap">
                                ...
                                >
                                    <ul class="py-1 text-sm text-gray-700">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.featuredBooks.show', $featuredBook->id) }}"
                                        ...
                                        <div id="editBookModal"
                                            ...
                                            <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 relative">
                                                ...
                                                <!-- FORM -->
                                                <form action="{{ route('admin.featuredBooks.update', $featuredBook->id) }}" 
                                                    method="POST" 
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <input type="date" name="publication_date"
                                                                class="w-full mt-1 px-3 py-2 border rounded-lg
                                                                    focus:outline-none focus:ring-2 focus:ring-pink-900"
                                                                    value="{{ $featuredBook->publication_date ?? '' }}">
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" name="cover_image" accept="image/*"
                                                            class="w-full mt-1 px-3 py-2 border rounded-lg
                                                                focus:outline-none focus:ring-2 focus:ring-pink-900"
                                                                value="{{ $featuredBook->cover_image ?? '' }}">
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" name="softCopyFile" accept=".pdf,.doc,.docx"
                                                            class="w-full mt-1 px-3 py-2 border rounded-lg
                                                                focus:outline-none focus:ring-2 focus:ring-pink-900"
                                                                value="{{ $featuredBook->softCopyFile ?? '' }}">
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <input type="number" step="0.01" name="softCopyPrice"
                                                                class="w-full mt-1 px-3 py-2 border rounded-lg
                                                                    focus:outline-none focus:ring-2 focus:ring-pink-900"
                                                                    value="{{ $featuredBook->softCopyPrice ?? '' }}">
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number" step="0.01" name="hardCopyPrice"
                                                                class="w-full mt-1 px-3 py-2 border rounded-lg
                                                                    focus:outline-none focus:ring-2 focus:ring-pink-900"
                                                                    value="{{ $featuredBook->hardCopyPrice ?? '' }}">
                                                        </div>
                                                    </div>
                                        ...
                                        <li>
                                            <form method="POST" action="{{ route('admin.featuredBooks.destroy', $featuredBook->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button
                                                    type="submit"
...
<div id="addBookModal"
    ...
    <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 relative">
        ...
        <!-- FORM -->
        <form action="{{ route('admin.featuredBooks.store') }}" 
            method="POST" 
            enctype="multipart/form-data"
            class="space-y-5">
            @csrf
